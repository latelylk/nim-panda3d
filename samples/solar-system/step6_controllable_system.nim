...
proc rotatePlanets(self: World) =
  ...
  self.day_period_moon = self.moon.hprInterval((0.0749 * self.yearscale), (360,
      0, 0), self.moon.getPos())
...
proc togglePlanet(self: World, planet: string, day: CInterval,
    orbit: CInterval = nil, text: OnscreenText) =
  var state: string
